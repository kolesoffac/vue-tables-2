module.exports = function(source) {
  return function(h) {
    ...
    return <div class={"VueTables VueTables--" + this.source}>
            ...
            <div class={classTable} style={`height: ${this.opts.fixedHeight}px`}>
                { this.opts.isFixedMode && <div class="fht-fixed-body" style={`width: ${this.fixedWidthAreaTable}px;`}>
                        <div class="fht-thead">
                            {getTable({thead: currentThead, classes: "fht-table fht-show-header-table", style: ""})}
                        </div>

                        <div class="fht-tbody" style={`height: ${this.opts.fixedHeight-100}px`}>
